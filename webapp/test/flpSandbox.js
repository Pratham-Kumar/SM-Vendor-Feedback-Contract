		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor Feedback Contract",
									"targetURL": "#comkposmvendorfeedbackcontractfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkposmvendorfeedbackcontractfiori-display": {
								"semanticObject": "comkposmvendorfeedbackcontractfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.smvendorfeedbackcontractfiori",
									"url": sap.ui.require.toUrl("com/kpo/smvendorfeedbackcontractfiori")
								}
							}
						}
					}
